...
export const PRODUCTS: Product[] = [
  {
    ...
    faq: [
      {
        q: 'Apa itu Holland Code (RIASEC)?',
        a: 'Holland Code adalah kerangka pemetaan minat vokasional yang dikembangkan psikolog John L. Holland (1959). Enam dimensi RIASEC — Realistic, Investigative, Artistic, Social, Enterprising, Conventional — mencerminkan tipe minat dan lingkungan kerja yang sesuai. Kombinasi 3 dimensi tertinggi Anda menjadi "code" unik yang memandu eksplorasi karier.',
      },
      {
      ...
      {
        q: 'Apakah hasil Holland Code bisa berubah seiring waktu?',
    ...
    seoDescription:
      'Temukan minat karier Anda dengan tes Holland Code RIASEC yang tervalidasi akademik. 15 menit, dapatkan rekomendasi karier dan jurusan untuk konteks Indonesia.',
    ...
    faq: [
      {
        ...
        a: 'PsyAI menggabungkan dua instrumen — Holland Code untuk minat vokasional dan MBTI-style typing untuk preferensi kepribadian — dalam satu laporan terintegrasi. Alih-alih dua hasil terpisah, Anda mendapat satu narasi kohesif yang menghubungkan minat, kepribadian, dan arah karier. AI berperan dalam narrative generation berbasis template yang telah divalidasi akademik oleh tim UNJANI.',
      },
      {
      ...
      },
      {
        ...
        a: 'Career Interest hanya menggunakan Holland Code dan berfokus pada pemetaan minat vokasional — cocok untuk yang sedang eksplorasi awal. PsyAI menggabungkan Holland Code + MBTI dan menghasilkan profil kepribadian yang lebih holistik dengan narrative AI. Jika Anda sudah tahu bidang yang diminati dan ingin memahami kepribadian kerja secara lebih mendalam, PsyAI adalah pilihan yang tepat.',
      },
    ],
    seoTitle: 'Tes Kepribadian AI Terintegrasi Holland dan MBTI | PsyAI Sekil.id',
    seoDescription:
      'PsyAI menggabungkan Holland Code dan MBTI dalam satu asesmen kepribadian terintegrasi. Dapatkan profil kepribadian komprehensif dan action plan karier dalam 25 menit.',
  ...
  },
  {
    ...
    faq: [
      {
        ...
        a: 'Tidak ada tes yang memberikan jaminan akurasi 100%. Path Finder AI memberikan rekomendasi berbasis profil minat (Holland Code) dan kepribadian (MBTI) Anda, disilangkan dengan data pasar kerja dan struktur kurikulum universitas Indonesia. Hasil bersifat indikatif dan dirancang sebagai titik diskusi, bukan keputusan final. Kami merekomendasikan mendiskusikan hasilnya dengan guru BK atau konselor karier.',
      },
      {
    ...
    seoDescription:
      'Pilih jurusan kuliah dengan data, bukan tebakan. Path Finder AI menggunakan Holland Code dan MBTI untuk merekomendasikan 5 jurusan terbaik dengan prospek karier Indonesia.',
  ...
  },
  {
    ...
    longDescription:
      'Leadership Styles Test dirancang untuk karyawan dan manajer yang ingin memahami dan mengembangkan gaya kepemimpinan mereka secara berbasis data. Menggunakan Papi Kostick — instrumen standar industri untuk konteks kerja profesional — tes ini mengidentifikasi gaya kepemimpinan dominan Anda dari 4 profil situasional, lengkap dengan matriks kekuatan, blind spot, dan rencana pengembangan yang dapat langsung diimplementasikan.',
    duration: '20 menit',
    price: 150000,
    priceDisplay: 'Rp 150.000',
    ...
    faq: [
      ...
      {
        q: 'Instrumen psikologi apa yang digunakan?',
        a: 'Leadership Styles Test menggunakan Papi Kostick yang diadaptasi untuk konteks kepemimpinan. Papi Kostick mengukur kebutuhan (needs) dan peran (roles) yang mendorong perilaku kerja — termasuk dimensi kepemimpinan, dominasi, dan orientasi hubungan. Instrumen ini telah digunakan dalam konteks pengembangan manajerial selama 50+ tahun dan divalidasi oleh UNJANI untuk konteks Indonesia.',
      },
      {
    ...
    seoDescription:
      'Identifikasi gaya kepemimpinan Anda dengan Papi Kostick. Leadership Styles Test menghasilkan profil 4 gaya situasional, matriks strength-blind spot, dan Individual Development Plan.',
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: 'Apakah instrumen EQ Test ini sudah divalidasi?',
        a: 'EQ Test Sekil.id menggunakan Papi Kostick yang diadaptasi untuk mengukur dimensi-dimensi kecerdasan emosional dalam konteks kerja. Adaptasi dilakukan oleh tim Fakultas Psikologi UNJANI dan telah melalui proses pilot testing dengan responden Indonesia. Instrumen bersifat deskriptif dan edukatif — bukan alat diagnostik klinis.',
      },
      {
        q: 'Apa bedanya EQ Test Sekil.id dengan tes EQ lain yang beredar online?',
        a: 'Sebagian besar tes EQ online tidak memiliki basis akademik yang jelas dan tidak dikalibrasi untuk konteks Indonesia. EQ Test Sekil.id dibangun di atas Papi Kostick yang digunakan dalam konteks profesional selama 50+ tahun, diadaptasi oleh psikolog UNJANI, dan menghasilkan laporan dalam Bahasa Indonesia native dengan rekomendasi yang relevan untuk lingkungan kerja Indonesia.',
      },
    ],
    seoTitle: 'Tes EQ Online Kecerdasan Emosional Tervalidasi | Sekil.id',
    seoDescription:
      'Ukur 4 dimensi Emotional Intelligence (EQ) dengan tes tervalidasi Papi Kostick. Dapatkan skor EQ, analisis mendalam, dan rencana pengembangan dalam 20 menit.',
