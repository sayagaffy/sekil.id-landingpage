...
export const SOLUTION_SEGMENTS: SolutionSegment[] = [
  ...
  },
  {
    ...
    stats: [
      { value: 'Rp 159k', label: 'Mulai dari per penerima manfaat' },
...
export const BUNDLES: Bundle[] = [
  ...
  },
  {
    ...
    productSlugs: ['job-burnout-test', 'professional-authenticity-test'],
    bundlePrice: 339000,
  },
  {
    id: 'self-awareness',
    ...
    productSlugs: ['self-discovery-ai', 'personal-authenticity-test', 'goal-align-ai'],
    bundlePrice: 489000,
  },
  {
  ...
  },
  {
    ...
    productSlugs: ['psyai', 'goal-align-ai', 'goal-orientation-coaching'],
    bundlePrice: 659000,
  },
];
